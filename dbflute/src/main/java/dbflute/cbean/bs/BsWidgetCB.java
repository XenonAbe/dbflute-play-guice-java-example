...
import dbflute.allcommon.ImplementedSqlClauseCreator;
import dbflute.cbean.*;
import dbflute.cbean.cq.*;

/**
 * The base condition-bean of WIDGET.
 * @author DBFlute(AutoGenerator)
 */
public class BsWidgetCB extends AbstractConditionBean {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected WidgetCQ _conditionQuery;
     ...
     * @return this. (NotNull)
     */
    public WidgetCB acceptPK(Integer id) {
        assertObjectNotNull("id", id);
        BsWidgetCB cb = this;
        cb.query().setId_Equal(id);
        return (WidgetCB)this;
    }
    ...
    protected WidgetCQ createLocalCQ() {
        return xcreateCQ(null, getSqlClause(), getSqlClause().getBasePointAliasName(), 0);
    }

    protected WidgetCQ xcreateCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        WidgetCQ cq = xnewCQ(childQuery, sqlClause, aliasName, nestLevel);
        cq.xsetBaseCB(this);
        return cq;
    }

    protected WidgetCQ xnewCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
    ...
    public static class HpSpecification extends HpAbstractSpecification<WidgetCQ> {
        ...
        @Override
        protected String getTableDbName() { return "WIDGET"; }
        /**
     ...
     */
    public WidgetCB dreamCruiseCB() {
        WidgetCB cb = new WidgetCB();
        cb.xsetupForDreamCruise((WidgetCB) this);
        return cb;
    }
