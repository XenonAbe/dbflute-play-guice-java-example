...
public abstract class AbstractBsWidgetCQ extends AbstractConditionQuery {
     ...
     */
    public HpSLCFunction<WidgetCB> scalar_Equal() {
        return xcreateSLCFunction(CK_EQ, WidgetCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<WidgetCB> scalar_NotEqual() {
        return xcreateSLCFunction(CK_NES, WidgetCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<WidgetCB> scalar_GreaterThan() {
        return xcreateSLCFunction(CK_GT, WidgetCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<WidgetCB> scalar_LessThan() {
        return xcreateSLCFunction(CK_LT, WidgetCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<WidgetCB> scalar_GreaterEqual() {
        return xcreateSLCFunction(CK_GE, WidgetCB.class);
    }
     ...
     * {where FOO &lt;= (select max(BAR) from ...)}
     * <pre>
     * cb.query().<span style="color: #CC4747">scalar_LessEqual()</span>.max(new SubQuery&lt;WidgetCB&gt;() {
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<WidgetCB> scalar_LessEqual() {
        return xcreateSLCFunction(CK_LE, WidgetCB.class);
    }
     ...
     */
    public void myselfExists(SubQuery<WidgetCB> subCBLambda) {
