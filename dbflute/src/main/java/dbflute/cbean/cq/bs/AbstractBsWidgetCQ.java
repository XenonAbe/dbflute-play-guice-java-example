...
/**
 * The abstract condition-query of WIDGET.
 * @author DBFlute(AutoGenerator)
 */
public abstract class AbstractBsWidgetCQ extends AbstractConditionQuery {

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public AbstractBsWidgetCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
    ...
    protected void regName(ConditionKey ky, Object vl) { regQ(ky, vl, getCValueName(), "NAME"); }
    ...
    protected void regPrice(ConditionKey ky, Object vl) { regQ(ky, vl, getCValuePrice(), "PRICE"); }
     ...
     * <pre>
     * cb.query().<span style="color: #DD4747">scalar_Equal()</span>.max(new SubQuery&lt;WidgetCB&gt;() {
     *     public void query(WidgetCB subCB) {
     ...
     */
    public HpSSQFunction<WidgetCB> scalar_Equal() {
        return xcreateSSQFunction(CK_EQ, WidgetCB.class);
    }
     ...
     * {where FOO &lt;&gt; (select max(BAR) from ...)
     * <pre>
     * cb.query().<span style="color: #DD4747">scalar_NotEqual()</span>.max(new SubQuery&lt;WidgetCB&gt;() {
     *     public void query(WidgetCB subCB) {
     *         subCB.specify().setXxx... <span style="color: #3F7E5E">// derived column for function</span>
     *         subCB.query().setYyy...
     *     }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSSQFunction<WidgetCB> scalar_NotEqual() {
        return xcreateSSQFunction(CK_NES, WidgetCB.class);
    }
     ...
     * {where FOO &gt; (select max(BAR) from ...)
     * <pre>
     * cb.query().<span style="color: #DD4747">scalar_GreaterThan()</span>.max(new SubQuery&lt;WidgetCB&gt;() {
     *     public void query(WidgetCB subCB) {
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSSQFunction<WidgetCB> scalar_GreaterThan() {
        return xcreateSSQFunction(CK_GT, WidgetCB.class);
    }
     ...
     * {where FOO &lt; (select max(BAR) from ...)
     * <pre>
     * cb.query().<span style="color: #DD4747">scalar_LessThan()</span>.max(new SubQuery&lt;WidgetCB&gt;() {
     *     public void query(WidgetCB subCB) {
     *         subCB.specify().setFoo... <span style="color: #3F7E5E">// derived column for function</span>
     *         subCB.query().setBar...
     *     }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSSQFunction<WidgetCB> scalar_LessThan() {
        return xcreateSSQFunction(CK_LT, WidgetCB.class);
    }
     ...
     * {where FOO &gt;= (select max(BAR) from ...)
     * <pre>
     * cb.query().<span style="color: #DD4747">scalar_GreaterEqual()</span>.max(new SubQuery&lt;WidgetCB&gt;() {
     *     public void query(WidgetCB subCB) {
     *         subCB.specify().setFoo... <span style="color: #3F7E5E">// derived column for function</span>
     *         subCB.query().setBar...
     *     }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSSQFunction<WidgetCB> scalar_GreaterEqual() {
        return xcreateSSQFunction(CK_GE, WidgetCB.class);
    }
     ...
     * {where FOO &lt;= (select max(BAR) from ...)
     * <pre>
     * cb.query().<span style="color: #DD4747">scalar_LessEqual()</span>.max(new SubQuery&lt;WidgetCB&gt;() {
     *     public void query(WidgetCB subCB) {
     *         subCB.specify().setFoo... <span style="color: #3F7E5E">// derived column for function</span>
     *         subCB.query().setBar...
     *     }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSSQFunction<WidgetCB> scalar_LessEqual() {
        return xcreateSSQFunction(CK_LE, WidgetCB.class);
    }

    @SuppressWarnings("unchecked")
    protected <CB extends ConditionBean> void xscalarCondition(String fn, SubQuery<CB> sq, String rd, HpSSQOption<CB> op) {
        assertObjectNotNull("subQuery", sq);
        WidgetCB cb = xcreateScalarConditionCB(); sq.query((CB)cb);
        String pp = keepScalarCondition(cb.query()); // for saving query-value
        op.setPartitionByCBean((CB)xcreateScalarConditionPartitionByCB()); // for using partition-by
        registerScalarCondition(fn, cb.query(), pp, rd, op);
    }
    public abstract String keepScalarCondition(WidgetCQ sq);

    protected WidgetCB xcreateScalarConditionCB() {
        WidgetCB cb = newMyCB(); cb.xsetupForScalarCondition(this); return cb;
    }

    protected WidgetCB xcreateScalarConditionPartitionByCB() {
        WidgetCB cb = newMyCB(); cb.xsetupForScalarConditionPartitionBy(this); return cb;
    }

    // ===================================================================================
    //                                                                       MyselfDerived
    //                                                                       =============
    public void xsmyselfDerive(String fn, SubQuery<WidgetCB> sq, String al, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        WidgetCB cb = new WidgetCB(); cb.xsetupForDerivedReferrer(this);
        try { lock(); sq.query(cb); } finally { unlock(); }
        String pp = keepSpecifyMyselfDerived(cb.query());
        String pk = "ID";
        registerSpecifyMyselfDerived(fn, cb.query(), pk, pk, pp, "myselfDerived", al, op);
    }
    public abstract String keepSpecifyMyselfDerived(WidgetCQ sq);

    /**
     * Prepare for (Query)MyselfDerived (correlated sub-query).
     * @return The object to set up a function for myself table. (NotNull)
     */
    public HpQDRFunction<WidgetCB> myselfDerived() {
        return xcreateQDRFunctionMyselfDerived(WidgetCB.class);
    }
    @SuppressWarnings("unchecked")
    protected <CB extends ConditionBean> void xqderiveMyselfDerived(String fn, SubQuery<CB> sq, String rd, Object vl, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        WidgetCB cb = new WidgetCB(); cb.xsetupForDerivedReferrer(this); sq.query((CB)cb);
        String pk = "ID";
        String sqpp = keepQueryMyselfDerived(cb.query()); // for saving query-value.
        String prpp = keepQueryMyselfDerivedParameter(vl);
        registerQueryMyselfDerived(fn, cb.query(), pk, pk, sqpp, "myselfDerived", rd, vl, prpp, op);
    }
    public abstract String keepQueryMyselfDerived(WidgetCQ sq);
     ...
     */
    public void myselfExists(SubQuery<WidgetCB> subQuery) {
        assertObjectNotNull("subQuery", subQuery);
        WidgetCB cb = new WidgetCB(); cb.xsetupForMyselfExists(this);
        try { lock(); subQuery.query(cb); } finally { unlock(); }
        String pp = keepMyselfExists(cb.query());
        registerMyselfExists(cb.query(), pp);
    }
    public abstract String keepMyselfExists(WidgetCQ sq);
     ...
     * @param subQuery The implementation of sub-query. (NotNull)
     */
    public void myselfInScope(SubQuery<WidgetCB> subQuery) {
        assertObjectNotNull("subQuery", subQuery);
        WidgetCB cb = new WidgetCB(); cb.xsetupForMyselfInScope(this);
        try { lock(); subQuery.query(cb); } finally { unlock(); }
        String pp = keepMyselfInScope(cb.query());
        registerMyselfInScope(cb.query(), pp);
    }
    public abstract String keepMyselfInScope(WidgetCQ sq);
    ...
    //                                                                       Very Internal
    //                                                                       =============
    protected WidgetCB newMyCB() {
        return new WidgetCB();
    }
    // very internal (for suppressing warn about 'Not Use Import')
    protected String xabUDT() { return Date.class.getName(); }
    protected String xabCQ() { return WidgetCQ.class.getName(); }
