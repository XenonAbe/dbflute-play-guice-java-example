...
import dbflute.bsentity.dbmeta.*;
 ...
 */
public abstract class BsWidgetBhv extends AbstractBehaviorWritable<Widget, WidgetCB> {
    ...
    //                                                                        ============
    /** {@inheritDoc} */
    public WidgetCB newConditionBean() { return new WidgetCB(); }
    ...
    protected OptionalEntity<Widget> facadeSelectByPK(Integer id) {
        return doSelectOptionalByPK(id, typeOfSelectedEntity());
    }

    protected <ENTITY extends Widget> ENTITY doSelectByPK(Integer id, Class<? extends ENTITY> tp) {
        return doSelectEntity(xprepareCBAsPK(id), tp);
    }

    protected <ENTITY extends Widget> OptionalEntity<ENTITY> doSelectOptionalByPK(Integer id, Class<? extends ENTITY> tp) {
        return createOptionalEntity(doSelectByPK(id, tp), id);
    }

    protected WidgetCB xprepareCBAsPK(Integer id) {
     ...
     * @param widgetList The list of widget. (NotNull, EmptyAllowed)
     * @return The list of the column value. (NotNull, EmptyAllowed, NotNullElement)
     */
    public List<Integer> extractIdList(List<Widget> widgetList)
    { return helpExtractListInternally(widgetList, "id"); }
     ...
     * @param widgetList The list of the entity. (NotNull, EmptyAllowed, PrimaryKeyNullAllowed: when auto-increment)
     * @return The array of inserted count. (NotNull, EmptyAllowed)
     */
    public int[] batchInsert(List<Widget> widgetList) {
        return doBatchInsert(widgetList, null);
    }
    ...
    //                                                                         Type Helper
    //                                                                         ===========
    protected Class<? extends Widget> typeOfSelectedEntity() { return Widget.class; }
    protected Class<Widget> typeOfHandlingEntity() { return Widget.class; }
    protected Class<WidgetCB> typeOfHandlingConditionBean() { return WidgetCB.class; }
}
