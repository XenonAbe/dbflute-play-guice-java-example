 ...
 */
public abstract class BsWidget extends AbstractEntity implements DomainEntity, EntityDefinedCommonColumn {
    ...
    protected boolean doEquals(Object obj) {
        if (obj instanceof BsWidget) {
            BsWidget other = (BsWidget)obj;
