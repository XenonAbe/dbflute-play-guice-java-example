...
public abstract class BsVendorCheckIntegerSumDtoMapper implements DtoMapper<VendorCheckIntegerSum, VendorCheckIntegerSumDto>, Serializable {
     ...
     * @return this. (NotNull)
     */
    public VendorCheckIntegerSumDtoMapper baseOnlyMapping() {
        setBaseOnlyMapping(true);
        return (VendorCheckIntegerSumDtoMapper)this;
    }
     ...
     * @return this. (NotNull)
     */
    public VendorCheckIntegerSumDtoMapper exceptCommonColumn() {
     ...
     * @return this. (NotNull)
     */
    public VendorCheckIntegerSumDtoMapper reverseReference() {
