...
public abstract class BsForcedTypeDtoMapper implements DtoMapper<ForcedType, ForcedTypeDto>, Serializable {
     ...
     * @return this. (NotNull)
     */
    public ForcedTypeDtoMapper baseOnlyMapping() {
        setBaseOnlyMapping(true);
        return (ForcedTypeDtoMapper)this;
    }
     ...
     * @return this. (NotNull)
     */
    public ForcedTypeDtoMapper exceptCommonColumn() {
     ...
     * @return this. (NotNull)
     */
    public ForcedTypeDtoMapper reverseReference() {
