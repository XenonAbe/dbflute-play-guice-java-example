...
public class VendorCheckIntegerSumDbm extends AbstractDBMeta {
    ...
    public static class EpgIntegerNonDigitSum implements PropertyGateway {
        ...
        public void write(Entity et, Object vl) { ((VendorCheckIntegerSum)et).setIntegerNonDigitSum(cti(vl)); }
    }
    ...
    //                                                                           Type Name
    //                                                                           =========
    public String getEntityTypeName() { return "com.example.dbflute.guice.dbflute.exentity.customize.VendorCheckIntegerSum"; }
