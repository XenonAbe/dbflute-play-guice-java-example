...
/**
 * The simple DTO of PmCommentHint. <br />
 * <pre>
 * [primary-key]
 *     
 * 
...
public abstract class BsPmCommentHintDto implements Serializable {
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof BsPmCommentHintDto)) { return false; }
        final BsPmCommentHintDto otherEntity = (BsPmCommentHintDto)other;
    ...
    public int hashCode() {
        int result = 17;
        result = xCH(result, "PmCommentHint");
