...
public abstract class BsVendorTheLongAndWindingTableAndColumnDtoMapper implements DtoMapper<VendorTheLongAndWindingTableAndColumn, VendorTheLongAndWindingTableAndColumnDto>, Serializable {
     ...
     * @return this. (NotNull)
     */
    public VendorTheLongAndWindingTableAndColumnDtoMapper baseOnlyMapping() {
        setBaseOnlyMapping(true);
        return (VendorTheLongAndWindingTableAndColumnDtoMapper)this;
    }
     ...
     * @return this. (NotNull)
     */
    public VendorTheLongAndWindingTableAndColumnDtoMapper exceptCommonColumn() {
     ...
     * @return this. (NotNull)
     */
    public VendorTheLongAndWindingTableAndColumnDtoMapper reverseReference() {
