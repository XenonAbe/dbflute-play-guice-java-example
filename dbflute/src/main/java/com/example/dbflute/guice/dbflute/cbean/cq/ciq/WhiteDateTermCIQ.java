...
public class WhiteDateTermCIQ extends AbstractBsWhiteDateTermCQ {
    ...
    //                                                                ====================
    protected ConditionValue getCValueDateTermId() { return _myCQ.getDateTermId(); }
    protected ConditionValue getCValueDateTermValue() { return _myCQ.getDateTermValue(); }
    protected ConditionValue getCValueBeginDate() { return _myCQ.getBeginDate(); }
    protected ConditionValue getCValueEndDate() { return _myCQ.getEndDate(); }
    ...
    public String keepMyselfInScope(WhiteDateTermCQ sq)
