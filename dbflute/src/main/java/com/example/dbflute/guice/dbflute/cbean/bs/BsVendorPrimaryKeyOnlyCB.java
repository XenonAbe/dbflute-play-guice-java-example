...
/**
 * The base condition-bean of VENDOR_PRIMARY_KEY_ONLY.
 * @author DBFlute(AutoGenerator)
 */
public class BsVendorPrimaryKeyOnlyCB extends AbstractConditionBean {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected VendorPrimaryKeyOnlyCQ _conditionQuery;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public BsVendorPrimaryKeyOnlyCB() {
     ...
     * @return this. (NotNull)
     */
    public VendorPrimaryKeyOnlyCB acceptPK(Long primaryKeyOnlyId) {
    ...
    public ConditionBean addOrderBy_PK_Desc() {
        query().addOrderBy_PrimaryKeyOnlyId_Desc();
        return this;
    }
    ...
    protected VendorPrimaryKeyOnlyCQ createLocalCQ() {
        return xcreateCQ(null, getSqlClause(), getSqlClause().getBasePointAliasName(), 0);
    }

    protected VendorPrimaryKeyOnlyCQ xcreateCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        VendorPrimaryKeyOnlyCQ cq = xnewCQ(childQuery, sqlClause, aliasName, nestLevel);
        cq.xsetBaseCB(this);
        return cq;
    }

    protected VendorPrimaryKeyOnlyCQ xnewCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
     ...
     * <pre>
     * cb.query().<span style="color: #DD4747">union</span>(new UnionQuery&lt;VendorPrimaryKeyOnlyCB&gt;() {
     *     public void query(VendorPrimaryKeyOnlyCB unionCB) {
     ...
     * because it inherits calls before. (Don't call SetupSelect after here)
     * <pre>
     * cb.query().<span style="color: #DD4747">unionAll</span>(new UnionQuery&lt;VendorPrimaryKeyOnlyCB&gt;() {
     *     public void query(VendorPrimaryKeyOnlyCB unionCB) {
     *         unionCB.query().setXxx...
     *     }
     * });
    ...
    public static class HpSpecification extends HpAbstractSpecification<VendorPrimaryKeyOnlyCQ> {
         ...
         */
        public HpSpecifiedColumn columnPrimaryKeyOnlyId() { return doColumn("PRIMARY_KEY_ONLY_ID"); }
        public void everyColumn() { doEveryColumn(); }
        public void exceptRecordMetaColumn() { doExceptRecordMetaColumn(); }
        @Override
        protected void doSpecifyRequiredColumn() {
            columnPrimaryKeyOnlyId(); // PK
        }
        @Override
        protected String getTableDbName() { return "VENDOR_PRIMARY_KEY_ONLY"; }
        /**
     ...
     * cb.<span style="color: #DD4747">columnQuery</span>(new SpecifyQuery&lt;VendorPrimaryKeyOnlyCB&gt;() {
     *     public void query(VendorPrimaryKeyOnlyCB cb) {
     *         cb.specify().<span style="color: #DD4747">columnFoo()</span>; <span style="color: #3F7E5E">// left column</span>
     *     }
     * }).lessThan(new SpecifyQuery&lt;VendorPrimaryKeyOnlyCB&gt;() {
     *     public void query(VendorPrimaryKeyOnlyCB cb) {
    ...
    protected VendorPrimaryKeyOnlyCB xcreateColumnQueryCB() {
     ...
     * cb.<span style="color: #DD4747">orScopeQuery</span>(new OrQuery&lt;VendorPrimaryKeyOnlyCB&gt;() {
     *     public void query(VendorPrimaryKeyOnlyCB orCB) {
     ...
     */
    public void orScopeQuery(OrQuery<VendorPrimaryKeyOnlyCB> orQuery) {
        xorSQ((VendorPrimaryKeyOnlyCB)this, orQuery);
    }
     ...
     *     public void query(VendorPrimaryKeyOnlyCB orCB) {
     *         orCB.query().setFOO_Equal...
     *         orCB.<span style="color: #DD4747">orScopeQueryAndPart</span>(new AndQuery&lt;VendorPrimaryKeyOnlyCB&gt;() {
     *             public void query(VendorPrimaryKeyOnlyCB andCB) {
     *                 andCB.query().setBar_...
     *                 andCB.query().setQux_...
     *             }
     *         });
     ...
     */
    public void orScopeQueryAndPart(AndQuery<VendorPrimaryKeyOnlyCB> andQuery) {
        xorSQAP((VendorPrimaryKeyOnlyCB)this, andQuery);
    }
    ...
    protected void xprepareSyncQyCall(ConditionBean mainCB) {
        final VendorPrimaryKeyOnlyCB cb;
        if (mainCB != null) {
            cb = (VendorPrimaryKeyOnlyCB)mainCB;
        } else {
            cb = new VendorPrimaryKeyOnlyCB();
        }
        specify().xsetSyncQyCall(new HpSpQyCall<VendorPrimaryKeyOnlyCQ>() {
            public boolean has() { return true; }
            public VendorPrimaryKeyOnlyCQ qy() { return cb.query(); }
        });
    }
