...
public class MemberDbm extends AbstractDBMeta {
    ...
    public static class EpgFormalizedDatetime implements PropertyGateway {
        ...
        public void write(Entity et, Object vl) { ((Member)et).setFormalizedDatetime((org.joda.time.LocalDateTime)vl); }
    }
    public static class EpgBirthdate implements PropertyGateway {
        public Object read(Entity et) { return ((Member)et).getBirthdate(); }
        public void write(Entity et, Object vl) { ((Member)et).setBirthdate((org.joda.time.LocalDate)vl); }
    }
    public static class EpgRegisterDatetime implements PropertyGateway {
        public Object read(Entity et) { return ((Member)et).getRegisterDatetime(); }
        public void write(Entity et, Object vl) { ((Member)et).setRegisterDatetime((org.joda.time.LocalDateTime)vl); }
    }
    ...
    public static class EpgUpdateDatetime implements PropertyGateway {
        ...
        public void write(Entity et, Object vl) { ((Member)et).setUpdateDatetime((org.joda.time.LocalDateTime)vl); }
    }
    ...
    public class EfpgMemberStatus implements PropertyGateway {
        ...
        public void write(Entity et, Object vl) { ((Member)et).setMemberStatus((OptionalEntity<MemberStatus>)vl); }
    }
    public class EfpgMemberAddressAsValid implements PropertyGateway {
        ...
        @SuppressWarnings("unchecked")
        public void write(Entity et, Object vl) { ((Member)et).setMemberAddressAsValid((OptionalEntity<MemberAddress>)vl); }
    }
    {
    ...
    public class EfpgMemberSecurityAsOne implements PropertyGateway {
        ...
        @SuppressWarnings("unchecked")
        public void write(Entity et, Object vl) { ((Member)et).setMemberSecurityAsOne((OptionalEntity<MemberSecurity>)vl); }
    }
    public class EfpgMemberServiceAsOne implements PropertyGateway {
        ...
        @SuppressWarnings("unchecked")
        public void write(Entity et, Object vl) { ((Member)et).setMemberServiceAsOne((OptionalEntity<MemberService>)vl); }
    }
    public class EfpgMemberWithdrawalAsOne implements PropertyGateway {
        ...
        @SuppressWarnings("unchecked")
        public void write(Entity et, Object vl) { ((Member)et).setMemberWithdrawalAsOne((OptionalEntity<MemberWithdrawal>)vl); }
    }
    ...
    protected final ColumnInfo _columnRegisterDatetime = cci("REGISTER_DATETIME", "REGISTER_DATETIME", null, "登録日時", org.joda.time.LocalDateTime.class, "registerDatetime", null, false, false, true, "TIMESTAMP", 23, 10, null, true, null, null, null, null, null);
    ...
    protected final ColumnInfo _columnUpdateDatetime = cci("UPDATE_DATETIME", "UPDATE_DATETIME", null, "更新日時", org.joda.time.LocalDateTime.class, "updateDatetime", null, false, false, true, "TIMESTAMP", 23, 10, null, true, null, null, null, null, null);
    ...
    public ForeignInfo foreignMemberStatus() {
        ...
        return cfi("FK_MEMBER_MEMBER_STATUS", "memberStatus", this, MemberStatusDbm.getInstance(), mp, 0, org.seasar.dbflute.optional.OptionalEntity.class, false, false, false, false, null, null, false, "memberList");
    }
    /**
    ...
    public ForeignInfo foreignMemberAddressAsValid() {
        ...
        return cfi("FK_MEMBER_MEMBER_ADDRESS_VALID", "memberAddressAsValid", this, MemberAddressDbm.getInstance(), mp, 1, org.seasar.dbflute.optional.OptionalEntity.class, true, true, false, true, "$$foreignAlias$$.VALID_BEGIN_DATE <= /*$$locationBase$$.parameterMapMemberAddressAsValid.targetDate*/null\n     and $$foreignAlias$$.VALID_END_DATE >= /*$$locationBase$$.parameterMapMemberAddressAsValid.targetDate*/null", newArrayList("targetDate"), false, null);
    }
    /**
    ...
    public ForeignInfo foreignMemberSecurityAsOne() {
        ...
        return cfi("FK_MEMBER_SECURITY_MEMBER", "memberSecurityAsOne", this, MemberSecurityDbm.getInstance(), mp, 2, org.seasar.dbflute.optional.OptionalEntity.class, true, false, true, false, null, null, false, "member");
    }
    /**
    ...
    public ForeignInfo foreignMemberServiceAsOne() {
        ...
        return cfi("FK_MEMBER_SERVICE_MEMBER", "memberServiceAsOne", this, MemberServiceDbm.getInstance(), mp, 3, org.seasar.dbflute.optional.OptionalEntity.class, true, false, true, false, null, null, false, "member");
    }
    /**
    ...
    public ForeignInfo foreignMemberWithdrawalAsOne() {
        ...
        return cfi("FK_MEMBER_WITHDRAWAL_MEMBER", "memberWithdrawalAsOne", this, MemberWithdrawalDbm.getInstance(), mp, 4, org.seasar.dbflute.optional.OptionalEntity.class, true, false, true, false, null, null, false, "member");
    }
