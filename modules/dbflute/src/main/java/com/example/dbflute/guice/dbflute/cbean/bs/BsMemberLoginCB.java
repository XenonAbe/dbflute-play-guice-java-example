...
public class BsMemberLoginCB extends AbstractConditionBean {
     ...
     * @return this. (NotNull)
     */
    public MemberLoginCB acceptUniqueOf(Integer memberId, org.joda.time.LocalDateTime loginDatetime) {
    ...
    public static class HpSpecification extends HpAbstractSpecification<MemberLoginCQ> {
        ...
        protected void doSpecifyRequiredColumn() {
            ...
            if (qyCall().qy().xgetReferrerQuery() instanceof PurchaseCQ) {
                columnMemberId(); // non PK but referred column (and referrer also non PK)
            }
