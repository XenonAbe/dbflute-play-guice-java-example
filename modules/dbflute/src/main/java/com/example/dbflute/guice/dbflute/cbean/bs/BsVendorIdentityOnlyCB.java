 ...
 */
public class BsVendorIdentityOnlyCB extends AbstractConditionBean {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected VendorIdentityOnlyCQ _conditionQuery;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public BsVendorIdentityOnlyCB() {
     ...
     * @return this. (NotNull)
     */
    public VendorIdentityOnlyCB acceptPK(Long identityOnlyId) {
        ...
        return (VendorIdentityOnlyCB)this;
    }
     ...
     */
    public VendorIdentityOnlyCQ query() {
        assertQueryPurpose(); // assert only when user-public query 
        return getConditionQuery();
    }

    public VendorIdentityOnlyCQ getConditionQuery() { // public for parameter comment and internal
    ...
    protected VendorIdentityOnlyCQ createLocalCQ() {
        return xcreateCQ(null, getSqlClause(), getSqlClause().getBasePointAliasName(), 0);
    }

    protected VendorIdentityOnlyCQ xcreateCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        VendorIdentityOnlyCQ cq = xnewCQ(childQuery, sqlClause, aliasName, nestLevel);
        cq.xsetBaseCB(this);
        return cq;
    }

    protected VendorIdentityOnlyCQ xnewCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
     ...
     */
    public void union(UnionQuery<VendorIdentityOnlyCB> unionQuery) {
        final VendorIdentityOnlyCB cb = new VendorIdentityOnlyCB(); cb.xsetupForUnion(this); xsyncUQ(cb); 
        try { lock(); unionQuery.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final VendorIdentityOnlyCQ cq = cb.query(); query().xsetUnionQuery(cq);
    }
     ...
     */
    public void unionAll(UnionQuery<VendorIdentityOnlyCB> unionQuery) {
        final VendorIdentityOnlyCB cb = new VendorIdentityOnlyCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionQuery.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final VendorIdentityOnlyCQ cq = cb.query(); query().xsetUnionAllQuery(cq);
    }
    ...
    public static class HpSpecification extends HpAbstractSpecification<VendorIdentityOnlyCQ> {
        ...
        @Override
        protected String getTableDbName() { return "VENDOR_IDENTITY_ONLY"; }
        /**
     ...
     */
    public HpColQyOperand<VendorIdentityOnlyCB> columnQuery(final SpecifyQuery<VendorIdentityOnlyCB> leftSpecifyQuery) {
    ...
    protected VendorIdentityOnlyCB xcreateColumnQueryCB() {
     ...
     */
    public void orScopeQuery(OrQuery<VendorIdentityOnlyCB> orQuery) {
        xorSQ((VendorIdentityOnlyCB)this, orQuery);
    }
     ...
     */
    public void orScopeQueryAndPart(AndQuery<VendorIdentityOnlyCB> andQuery) {
        xorSQAP((VendorIdentityOnlyCB)this, andQuery);
    }
    ...
    protected void xprepareSyncQyCall(ConditionBean mainCB) {
        final VendorIdentityOnlyCB cb;
        if (mainCB != null) {
            cb = (VendorIdentityOnlyCB)mainCB;
        } else {
    ...
    protected String getConditionBeanClassNameInternally() { return VendorIdentityOnlyCB.class.getName(); }
    protected String getConditionQueryClassNameInternally() { return VendorIdentityOnlyCQ.class.getName(); }
