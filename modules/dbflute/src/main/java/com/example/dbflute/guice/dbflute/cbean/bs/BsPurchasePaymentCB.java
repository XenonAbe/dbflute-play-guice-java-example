...
public class BsPurchasePaymentCB extends AbstractConditionBean {
     ...
     */
    public void union(UnionQuery<PurchasePaymentCB> unionQuery) {
     ...
     */
    public void unionAll(UnionQuery<PurchasePaymentCB> unionQuery) {
        final PurchasePaymentCB cb = new PurchasePaymentCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionQuery.query(cb); } finally { unlock(); } xsaveUCB(cb);
     ...
     * PurchasePayment purchasePayment = purchasePaymentBhv.selectEntityWithDeletedCheck(cb);
    ...
    public static class HpSpecification extends HpAbstractSpecification<PurchasePaymentCQ> {
        ...
        public HpSDRFunction<PurchasePaymentCB, PurchasePaymentCQ> myselfDerived() {
            ...
            return new HpSDRFunction<PurchasePaymentCB, PurchasePaymentCQ>(_baseCB, _qyCall.qy(), new HpSDRSetupper<PurchasePaymentCB, PurchasePaymentCQ>() {
                public void setup(String fn, SubQuery<PurchasePaymentCB> sq, PurchasePaymentCQ cq, String al, DerivedReferrerOption op) {
     ...
     */
    public HpColQyOperand<PurchasePaymentCB> columnQuery(final SpecifyQuery<PurchasePaymentCB> leftSpecifyQuery) {
     ...
     */
    public void orScopeQuery(OrQuery<PurchasePaymentCB> orQuery) {
        xorSQ((PurchasePaymentCB)this, orQuery);
    }
     ...
     */
    public void orScopeQueryAndPart(AndQuery<PurchasePaymentCB> andQuery) {
        xorSQAP((PurchasePaymentCB)this, andQuery);
    }
    ...
    protected void xprepareSyncQyCall(ConditionBean mainCB) {
        ...
        specify().xsetSyncQyCall(new HpSpQyCall<PurchasePaymentCQ>() {
            public boolean has() { return true; }
            public PurchasePaymentCQ qy() { return cb.query(); }
        });
    }
