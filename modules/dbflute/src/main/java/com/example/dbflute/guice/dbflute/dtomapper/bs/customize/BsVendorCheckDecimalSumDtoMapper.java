...
public abstract class BsVendorCheckDecimalSumDtoMapper implements DtoMapper<VendorCheckDecimalSum, VendorCheckDecimalSumDto>, Serializable {
     ...
     * @return this. (NotNull)
     */
    public VendorCheckDecimalSumDtoMapper baseOnlyMapping() {
        setBaseOnlyMapping(true);
        return (VendorCheckDecimalSumDtoMapper)this;
    }
     ...
     * @return this. (NotNull)
     */
    public VendorCheckDecimalSumDtoMapper exceptCommonColumn() {
     ...
     * @return this. (NotNull)
     */
    public VendorCheckDecimalSumDtoMapper reverseReference() {
