...
public abstract class BsVendorIdentityOnlyDtoMapper implements DtoMapper<VendorIdentityOnly, VendorIdentityOnlyDto>, Serializable {
     ...
     * @return this. (NotNull)
     */
    public VendorIdentityOnlyDtoMapper baseOnlyMapping() {
        setBaseOnlyMapping(true);
        return (VendorIdentityOnlyDtoMapper)this;
    }
     ...
     * @return this. (NotNull)
     */
    public VendorIdentityOnlyDtoMapper exceptCommonColumn() {
     ...
     * @return this. (NotNull)
     */
    public VendorIdentityOnlyDtoMapper reverseReference() {
