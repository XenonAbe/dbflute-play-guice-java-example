...
public class DBMetaInstanceHandler implements DBMetaProvider {
    ...
    static {
        ...
        tmpMap.put("PURCHASE_PAYMENT", "com.example.dbflute.guice.dbflute.bsentity.dbmeta.PurchasePaymentDbm");
        ...
        tmpMap.put("WHITE_DATE_TERM", "com.example.dbflute.guice.dbflute.bsentity.dbmeta.WhiteDateTermDbm");
